...
После утверждения спеки — добавить в `docs/business-logic.md` раздел «Прогресс (этапы)» с сущностями и правилами доступа из этого документа.
